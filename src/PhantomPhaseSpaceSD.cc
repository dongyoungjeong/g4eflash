...
PhantomPhaseSpaceSD::PhantomPhaseSpaceSD(const G4String &name) : G4VSensitiveDetector(name) {}

PhantomPhaseSpaceSD::~PhantomPhaseSpaceSD() {}

G4bool PhantomPhaseSpaceSD::ProcessHits(G4Step *step, G4TouchableHistory *){
    ...
    //     G4cerr << "PhantomPhaseSpaceSD: copy number out of range: " << planeIndex << G4endl;
    //     return false;
    // }
